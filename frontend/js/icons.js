...
export const ICONES = {
  ...
  "help": [C(12, 12, 9.5), P("M9.3 9.4a2.8 2.8 0 0 1 5.4 1c0 1.9-2.7 2.3-2.7 4"), PONTO(12, 17.6, 1)],
  "clock": [C(12, 12, 9.5), P("M12 6.5V12l3.5 2")],
  "award": [C(12, 9, 5.5), P("M8.6 13.6L7 21l5-2.8 5 2.8-1.6-7.4"), P("M9.7 9l1.7 1.7 3-3.2")],
  "qr": [R(3.5, 3.5, 7, 7, 1), R(13.5, 3.5, 7, 7, 1), R(3.5, 13.5, 7, 7, 1), PONTO(6.9, 6.9, 1), PONTO(17, 6.9, 1), PONTO(6.9, 17, 1), P("M13.5 13.5h3v3"), P("M20.5 13.5v7h-4"), P("M13.5 17.5v3")],
  "tablet": [R(4.5, 2.5, 15, 19, 2.5), P("M10.5 18.5h3")],
  "tv": [R(2.5, 5, 19, 12.5, 2), P("M8 21h8"), P("M12 17.5V21")],
  "keyboard": [R(2.5, 6, 19, 12, 2.5), P("M6.5 10h.01"), P("M10 10h.01"), P("M14 10h.01"), P("M17.5 10h.01"), P("M8 14.5h8")],
  "search": [C(10.5, 10.5, 6.5), P("M15.5 15.5L21 21")],
  "user": [C(12, 8, 4), P("M4.5 20.5c.8-4 3.7-6 7.5-6s6.7 2 7.5 6")],
  "star": [P("M12 3l2.7 5.6 6.1.9-4.4 4.3 1 6.1L12 17l-5.4 2.9 1-6.1-4.4-4.3 6.1-.9z")],
  "arrow-right": [P("M4 12h16"), P("M14 6l6 6-6 6")],
  "list": [P("M9 6.5h11"), P("M9 12h11"), P("M9 17.5h11"), PONTO(4.8, 6.5, 1.1), PONTO(4.8, 12, 1.1), PONTO(4.8, 17.5, 1.1)],
};
