...
const CACHE = "quiztech-shell-v2.4.4"; // acompanha APP_VERSION (js/versao.js); um teste confere
const ARQUIVOS = [
  ...
  "assets/logo/logo.png", "assets/logo/logo-circular.png", "assets/logo/favicon.png", "assets/fonts/orbitron-latin.woff2", "assets/bg-pattern.svg",
